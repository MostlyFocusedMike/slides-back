...
slide1 = Slide.create(video: vid, title: "Slide One")
slide2 = Slide.create(video: vid, title: "Slide Two", start: 3, timecode: "0:03")
slide3 = Slide.create(video: vid, title: "Slide Three", start: 5, timecode: "0:05")
slide4 = Slide.create(video: vid, title: "Slide Four", start: 7, timecode: "0:07")
slide5 = Slide.create(video: vid, title: "Slide Five", start: 9, timecode: "0:09")
