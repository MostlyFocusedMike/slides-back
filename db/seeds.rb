...
slide2 = Slide.create(video: vid, title: "Slide Two", start: 3)
slide3 = Slide.create(video: vid, title: "Slide Three", start: 5)
slide4 = Slide.create(video: vid, title: "Slide Four", start: 7)
slide5 = Slide.create(video: vid, title: "Slide Five", start: 9)
